...
export default function LeafDivider() {
  ...
  return (
    <div
      className="relative select-none overflow-x-hidden overflow-y-visible py-16 md:py-10"
      style={{ ...edgeMask, zIndex: 2147483647 as unknown as number, position: 'relative' }}
    >
      {/* stripe */}
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center rotate-180"
           style={{ zIndex: 2147483647 as unknown as number }}>
